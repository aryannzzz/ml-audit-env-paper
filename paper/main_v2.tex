...
These extensions collectively address the major open questions in the
original release: human-comparison gap, uncharacterised evaluation
variance, archetype coverage, grader sensitivity, model diversity, and
synthetic-only scope (Section~\ref{sec:limitations}).
